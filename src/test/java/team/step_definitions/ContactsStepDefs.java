...
import team.pages.ContactsPage;
...
public class ContactsStepDefs {
    ...
    public void enter_a_into_fullname_inbox(String fullname) {
        ...
        Utils.waitForClickablility(contactsPage.fullnamebox,5);
    ...
    public void verify_new_contact_is_shown_in_contact_list() {
        ContactsPage contactsPage = new ContactsPage();
        List<String> contacts = Utils.getElementsText(contactsPage.contactList);
        Utils.waitFor(2);
